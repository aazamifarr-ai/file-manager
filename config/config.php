...
setlocale(LC_CTYPE, 'fa'); //correct transliteration
...
$config = array(
    ...
    */
    ...
    'fixed_path_from_filemanager'             => array('../min/', '../minx/'), //fixed path of the image folder from the current position on upload folder

...
if (is_array($config['hidden_folders']) && count($config['hidden_folders'])) {
...
<head>
    ...
    <script type="text/javascript" src="js/plugins.js?v=<?php echo $version; ?>"></script>
    ...
    <script src="js/include.js?v=<?php echo $version . time(); ?>"></script>
</head>
    ...
    <div class="container-fluid">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span6 entire types">
                                    ...
                                    <?php if ($_GET['type'] != 1 && $_GET['type'] != 3 && $config['show_filter_buttons']) { ?>
                                        <?php if (is_array($config['ext_file']) && count($config['ext_file']) > 0 or false) { ?>
                                        ...
                                        <?php } ?>
                                        <?php if (is_array($config['ext_img']) && count($config['ext_img']) > 0 or false) { ?>
                                        ...
                                        <?php } ?>
                                        <?php if (is_array($config['ext_misc']) && count($config['ext_misc']) > 0 or false) { ?>
                                        ...
                                        <?php } ?>
                                        <?php if (is_array($config['ext_video']) && count($config['ext_video']) > 0 or false) { ?>
                                        ...
                                        <?php } ?>
                                        <?php if (is_array($config['ext_music']) && count($config['ext_music']) > 0 or false) { ?>
        ...
        <div class="row-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li class="pull-right"><small class="hidden-phone">(<span id="files_number"><?php echo $current_files_number . "</span> " . trans('Files') . " - <span id='folders_number'>" . $current_folders_number . "</span> " . trans('Folders'); ?>)</small></li>
                <?php if ($config['show_total_size']) { ?>
                    <li class="pull-right"><small class="hidden-phone"><span title="<?php echo trans('total size') . $config['MaxSizeTotal']; ?>"><?php echo trans('total size') . ": " . makeSize($sizeCurrentFolder) . (($config['MaxSizeTotal'] !== false && is_int($config['MaxSizeTotal'])) ? '/' . $config['MaxSizeTotal'] . ' ' . trans('MB') : ''); ?></span></small>
                    </li>
                <?php } ?>
            </ul>
        </div>

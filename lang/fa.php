...
return array(
    ...
    'Select' => 'انتخاب',
    'Deselect_All' => 'لغو همه انتخاب ها',
    ...
    'Upload_base_help' => "با درگ دراپ و یا کلیک روی دکمه انتخاب فایل میتوانید فایل های خود را انتخاب کنید و سپس با دکمه شروع آپلود آنها را بارگزاری کنید و با دکمه بازگشت به لیست به مرحله قبل بازگردید.",
    'Upload_add_files' => 'اضافه کردن فایل',
    'Upload_start' => 'شروع آپلود',
    'Upload_error_messages' => array(
        1 => 'حجم فایل انتخاب شده بیش از حد پارامتر upload_max_filesize در تنظیمات php.ini است.',
        2 => 'حجم فایل انتخاب شده بیش از حد مجاز است.',
        3 => 'فایل ها به صورت ناقص آپلود شده اند.',
        4 => 'هیچ فایلی آپلود نشد.',
        6 => 'پوشه فایل های موقتی در دسترس نیست.',
        7 => 'خطا در نوشتن فایل روی دیسک',
        8 => 'آپلود فایل های با پسوند php غیر مجاز است.',
        'post_max_size' => 'حجم فایل انتخاب شده بیش از حد پارامتر post_max_size در تنظیمات php.ini است.',
        'max_file_size' => 'حجم فایل بیش از حد بزرگ است.',
        'min_file_size' => 'حجم فایل بیش از حد کوچک است.',
        'accept_file_types' => 'نوع فایل مجاز نیست.',
        'max_number_of_files' => 'حداکثر تعداد فایل ها بیش از حد مجاز است.',
        'max_width' => 'تصویر بیش از حداکثر عرض مشخص شده است.',
        'min_width' => 'تصویر نیاز به حداقل عرض مشخص شده دارد.',
        'max_height' => 'تصویر بیش از حداکثر ارتفاع مشخص شده است.',
        'min_height' => 'تصویر نیاز به حداقل ارتفاع مشخص شده دارد.',
        'abort' => 'آپلود فایل لغو شد.',
        'image_resize' => 'خطا در تغییر سایز تصویر'
    ),
    'Upload_url' => 'آپلود از آدرس اینترنتی',
    'Type_dir' => 'پوشه',
    'Type' => 'نوع',
    'Dimension' => 'بعد',
    'Size' => 'اندازه',
